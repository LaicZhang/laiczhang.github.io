---
title: 我的hexo站点config.yml文件配置
copyright: true
date: 2019-07-06 14:08:27
updated: 2019-07-06 14:08:27
tags:
  - hexo
  - config
  - next
categories: hexo
keywords: hexo,config,配置
...
```yml
# my website is laiczhang.github.io , welcome to visit.
# This configuration is for personal use and is for informational purposes only.
...
favicon:
  ...
  medium: /images/github-brands.svg # favicon-32x32-next.png
...
github_banner:
  enable: true
  permalink: https://github.com/LaicZhang
...
# Tips: Before you open this tag, remember set up your URL in hexo _config.yml (e.g. url: https://yourdomain.com)
canonical: true
...
#google_site_verification: G95E7SA5U7eo4GJerEzaSYRiOLxPvI43QNQjTqX-GVY
...
# External url should start with https:// or https://
menu:
  home: / || home
  about: /about/ || user 
  tags: /tags/ || tags
...
social:
  GitHub: https://github.com/LaicZhang || github
  E-Mail: mailto:i@laiczhang.com || envelope
  CSDN: https://blog.csdn.net/qq_44621510 || cuttlefish
  #V2EX: https://www.v2ex.com/member/LaicZhang || vimeo
  Weibo: https://weibo.com/laiczhang || weibo
  #Google: https://plus.google.com/yourname || google
  Twitter: https://twitter.com/zMbK5gdHxMNmDFq?s=09 || twitter
  Facebook: https://www.facebook.com/profile.php?id=100035357056010 || facebook
...
avatar:
  ...
  url: /images/鼬.jpg  #/images/avatar.gif
...
wechat_subscriber:
  enable: true
  qcode: /images/panda一块砖1.png
  description: Welcome to scan the QR code to follow my WeChat public account
# Reward (Donate)
reward_settings:
...
post_edit:
  enable: true
  url: https://github.com/LaicZhang/laiczhang.github.io # Link for view source.
...
# Get more information on https://ibruce.info/2015/04/04/busuanzi
busuanzi_count:
  enable: true
  total_visitors: true
